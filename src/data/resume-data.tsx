...
export const RESUME_DATA = {
  ...
  summary:
    "Hi everyone, my name is Nguyen Van Dung, but you can call me \"vandunxg\". I'm an intern studying Information Technology at the University of Transport Technology. I love learning about new technologies such as Programming Language, Big Data, Blockchain... I want to acquire all the skills I can use for my profession and I want to be a Developer soon. Nice to connect with you!",
